...
SECRET_KEY = os.getenv("SECRET_KEY", default='This is the default')
...
ALLOWED_HOSTS = ['https://deploy-miniblog.herokuapp.com',
                 'localhost',
                 '127.0.0.1'
                 ]
...
DEFAULT_FROM_EMAIL = 'victorestigarribia60@gmail.com'
